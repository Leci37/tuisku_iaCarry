...
plt = detection_model.plot_parameter_setup_config(plt)
#
...
for i in range(1, 6):
    ...
    list_train_images_np.append( detection_model.load_image_into_numpy_array(path_img_to_train))
...
for idx in range(len(list_train_images_np)):
    ...
    detection_model.plot_detections(
...
detection_model.save_detecion_pd_checkpoint(detection_model, PATH_MODELS_CHECKPOINT_STEP_STPE, configs)

"""# Load test images and run inference with new model!"""
list_test_images_np = detection_model.get_valitation_images()
