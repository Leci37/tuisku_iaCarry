...
import tflite_info
from tflite_metadata import mdata_write_all_in_tflite_SIMPLE, log_metadata_info_tflite, mdata_write_all_in_tflite_FULL
...
tflite_info.Log_TFlite_info_file(TF_LITE_PATH)
...
tflite_info.Log_TFlite_info_file(TF_LITE_PATH_2)
...
tflite_info.Log_TFlite_info_file(TF_LITE_PATH_D)
