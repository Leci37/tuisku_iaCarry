...
from common import detection_model
...
from common.detection_signature import img_proccess, draw_bounding_box_on_image
from tflite_detect_utils import detect_objects_TFlite
...
input_std = 127.5
HUMBRAL_PREDTIC = 0.5
CATEGORY_INDEX = detection_model.get_category_index()
