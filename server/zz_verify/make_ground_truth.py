...
Each detection in zz_sample_upload_response.json above the UI threshold is
...
def main(out_dir, fixture_path, template_path=None):
    ...
    if not os.path.exists(template_path):
        template_path = os.path.join(os.path.dirname(os.path.abspath(fixture_path)),
                                     "iaCarry_Local_JS_1_Clouding.html")
