...
for tag in  list_tags:
    ...
    print("Label loaded Name: ", name_tag, " Shape: ", df_n[80:-50].shape)

    for index, row in df_n[80:-50].iterrows():


        copy_tesT_path  = row['path'].replace(r'E:\iaCarry_img_eroski\frames_rota_fon', r'E:\iaCarry_img_eroski\frames_rota_fon_TEST')
        os.rename(row['path'],copy_tesT_path  )# "\\".join(copy_tesT_path.split("\\")[:-1]))
        print(copy_tesT_path)
