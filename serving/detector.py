...
import server_utils
from server_utils import bcolors
...
class Detector_model:
    ...
    def __init__(self):
        ...
        _test_images_np = server_utils.load_image_into_numpy_array_by_Image_open([r"..\iacarry-evaluation\zTest_img.jpg"])
    ...
    def do_prediction_from_list_paths(self, path_img, rid = ""):
        ...
        # _test_images_np = server_utils.load_image_into_numpy_array_by_Image_open(list_img)
        ...
        df, path_img_box = server_utils.manage_plot_and_save_img_predicted(detections, df, self.NUM_CHECK_POINT_OR_NAME_FOLDER,PATH_TO_SAVED=self.PATH_TO_SAVED,Category_index=self.Category_index,
        ...
        if df.shape[0] != 0:
            ...
            server_utils.register_MULTI_in_zTelegram_Registers(df_r=df, PATH_REGISTER_RESULT_REAL_TIME=path_to_csv)
